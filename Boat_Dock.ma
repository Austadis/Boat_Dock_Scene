...
//Name: Boat_Dock.ma
//Last modified: Fri, Oct 04, 2024 05:40:17 PM
//Codeset: UTF-8
...
fileInfo "UUID" "51645D6C-0C41-E471-2C55-51B72C4AABB6";
createNode transform -s -n "persp";
	rename -uid "4B58B077-114C-98D5-B172-96BC78469F6C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.001894716597457 6.2541058379943424 18.4631307748319 ;
	setAttr ".r" -type "double3" -15.93835272960237 19.399999999998709 4.2150104414160796e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "55CEFE9A-2741-BCB1-97C8-F688BED7C915";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 20.357093256306673;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 4.5 0.66398840347357435 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B701C53D-AC4A-7554-B40E-A68E7A5D3DA7";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "27F52437-1840-3167-2360-15A482E117BC";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "A8BEB776-3941-883A-5457-A29D783901DF";
createNode displayLayerManager -n "layerManager";
	rename -uid "2EA840DF-684E-677A-400B-0AA2243F5642";
createNode displayLayer -n "defaultLayer";
	rename -uid "1CA804B1-DC45-0E5B-425C-60B00B571DA5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "87DB32E5-8345-9716-B4B1-ECB2081AD05D";
